...
CREATE FUNCTION update_boundingbox_layer() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION update_boundingbox_layer_default() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
   IF (TG_OP = 'DELETE') THEN
...
CREATE FUNCTION update_messtischblatt_georef() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION update_nutzer_bonuspunkte() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
   IF (TG_OP = 'DELETE') THEN
...
--
-- Name: utmzone(geometry); Type: FUNCTION; Schema: public; Owner: vkviewer
--
...
ALTER FUNCTION public.utmzone(geometry) OWNER TO vkviewer;
...
--
-- Name: adminjobs; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
CREATE SEQUENCE adminjobs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE adminjobs_id_seq OWNED BY adminjobs.id;


--
-- Name: xfehlermeldungen; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE xfehlermeldungen (
    id integer NOT NULL,
...
CREATE SEQUENCE fehlermeldungen_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE fehlermeldungen_id_seq OWNED BY xfehlermeldungen.id;
...
--
-- Name: georeferenzierungsprozess; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE georeferenzierungsprozess (
    id integer NOT NULL,
...
CREATE SEQUENCE georeferenzierungsprozess_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE georeferenzierungsprozess_id_seq OWNED BY georeferenzierungsprozess.id;


--
-- Name: gt_pk_metadata_table; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.gt_pk_metadata_table OWNER TO postgres;
...
CREATE SEQUENCE maps_apsobjectid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE maps_apsobjectid_seq OWNED BY map.apsobjectid;
...
ALTER SEQUENCE maps_id_seq OWNED BY map.id;
...
--
-- Name: refmaplayer; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE refmaplayer (
    layerid integer NOT NULL,
    mapid integer NOT NULL
);


ALTER TABLE public.refmaplayer OWNER TO postgres;
...
CREATE VIEW vblattschnittmtb AS
SELECT metadata.blattnr, map.id AS mapid, date_part('year'::text, metadata.timepublish) AS "time" FROM map, metadata WHERE (map.id = metadata.mapid);


ALTER TABLE public.vblattschnittmtb OWNER TO postgres;

--
-- Name: virtualdatasets; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE virtualdatasets (
    id integer NOT NULL,
    layerid integer NOT NULL,
...
CREATE SEQUENCE virtualdatasets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE virtualdatasets_id_seq OWNED BY virtualdatasets.id;
...
CREATE VIEW vmapsearch AS
SELECT maps.id, maps.apsdateiname AS dataid, date_part('year'::text, metadata.timepublish) AS "time", metadata.titleshort AS title, metadata.apspermalink AS plink, metadata.imagejpg AS org, st_transform(maps.boundingbox, 900913) AS boundingbox FROM (map maps LEFT JOIN metadata ON ((maps.id = metadata.mapid))) WHERE (maps.isttransformiert = true);


ALTER TABLE public.vmapsearch OWNER TO postgres;

--
-- Name: xblattschnitt_mtb; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE xblattschnitt_mtb (
    blattnr character(6) NOT NULL,
    geom geometry,
    CONSTRAINT enforce_dims_geom CHECK ((st_ndims(geom) = 2)),
    CONSTRAINT enforce_geotype_geom CHECK (((geometrytype(geom) = 'MULTIPOLYGON'::text) OR (geom IS NULL))),
    CONSTRAINT enforce_srid_geom CHECK ((st_srid(geom) = 4314))
);
...
ALTER TABLE ONLY adminjobs ALTER COLUMN id SET DEFAULT nextval('adminjobs_id_seq'::regclass);
...
ALTER TABLE ONLY georeferenzierungsprozess ALTER COLUMN id SET DEFAULT nextval('georeferenzierungsprozess_id_seq'::regclass);
...
ALTER TABLE ONLY map ALTER COLUMN id SET DEFAULT nextval('maps_id_seq'::regclass);


--
-- Name: apsobjectid; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY map ALTER COLUMN apsobjectid SET DEFAULT nextval('maps_apsobjectid_seq'::regclass);
...
ALTER TABLE ONLY virtualdatasets ALTER COLUMN id SET DEFAULT nextval('virtualdatasets_id_seq'::regclass);
...
ALTER TABLE ONLY xfehlermeldungen ALTER COLUMN id SET DEFAULT nextval('fehlermeldungen_id_seq'::regclass);


--
-- Name: adminjobs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY adminjobs
    ADD CONSTRAINT adminjobs_pkey PRIMARY KEY (id);


--
-- Name: fehlermeldungen_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY xfehlermeldungen
...
--
-- Name: georeferenzierungsprozess_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY georeferenzierungsprozess
    ADD CONSTRAINT georeferenzierungsprozess_pkey PRIMARY KEY (id);


--
-- Name: gt_pk_metadata_table_table_schema_table_name_pk_column_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: messtischblattgrid_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY xblattschnitt_mtb
...
--
-- Name: pkey_refmaplayer; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY refmaplayer
...
--
-- Name: unique_apsdateiname; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: virtualdatasets_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY virtualdatasets
    ADD CONSTRAINT virtualdatasets_pkey PRIMARY KEY (layerid, "timestamp");


--
-- Name: blattnr_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX blattnr_idx ON xblattschnitt_mtb USING btree (blattnr);


--
-- Name: fki_georeferenzierungsprozess_maps_fkey; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX fki_georeferenzierungsprozess_maps_fkey ON georeferenzierungsprozess USING btree (mapid);


--
-- Name: idx_georeferenzierungsprozess_id; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX idx_georeferenzierungsprozess_id ON georeferenzierungsprozess USING btree (id);


--
-- Name: idx_maps_id; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX idx_maps_id ON map USING btree (id);


--
-- Name: idx_refmtblayer_layer; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX idx_refmtblayer_layer ON refmaplayer USING btree (layerid);


--
-- Name: isactive_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX isactive_idx ON georeferenzierungsprozess USING btree (mapid) WHERE (isactive = true);


--
-- Name: maps_boundingbox_gist; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX maps_boundingbox_gist ON map USING gist (boundingbox);

ALTER TABLE map CLUSTER ON maps_boundingbox_gist;


--
-- Name: trigger_update_layer_boundingbox; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_update_layer_boundingbox AFTER INSERT OR DELETE ON refmaplayer FOR EACH ROW EXECUTE PROCEDURE update_boundingbox_layer();

ALTER TABLE refmaplayer DISABLE TRIGGER trigger_update_layer_boundingbox;


--
-- Name: trigger_update_messtischblatt; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_update_messtischblatt AFTER INSERT OR DELETE OR UPDATE ON georeferenzierungsprozess FOR EACH ROW EXECUTE PROCEDURE update_messtischblatt_georef();


--
-- Name: adminjobs_georeferenzierungsprozess_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY adminjobs
    ADD CONSTRAINT adminjobs_georeferenzierungsprozess_fkey FOREIGN KEY (georefid) REFERENCES georeferenzierungsprozess(id);


--
-- Name: fkey_refmaplayer_layer; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY refmaplayer
    ADD CONSTRAINT fkey_refmaplayer_layer FOREIGN KEY (layerid) REFERENCES layer(id);


--
-- Name: fkey_refmaplayer_map; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY refmaplayer
    ADD CONSTRAINT fkey_refmaplayer_map FOREIGN KEY (mapid) REFERENCES map(id);


--
-- Name: metadata_maps_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY metadata
    ADD CONSTRAINT metadata_maps_fkey FOREIGN KEY (mapid) REFERENCES map(id);


--
-- Name: virtualdatasets_layer_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY virtualdatasets
    ADD CONSTRAINT virtualdatasets_layer_fkey FOREIGN KEY (layerid) REFERENCES layer(id);
...
--
-- Name: adminjobs; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE adminjobs FROM PUBLIC;
REVOKE ALL ON TABLE adminjobs FROM postgres;
GRANT ALL ON TABLE adminjobs TO postgres;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE adminjobs TO vkviewer;


--
-- Name: adminjobs_id_seq; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON SEQUENCE adminjobs_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE adminjobs_id_seq FROM postgres;
GRANT ALL ON SEQUENCE adminjobs_id_seq TO postgres;
GRANT ALL ON SEQUENCE adminjobs_id_seq TO vkviewer;


--
-- Name: xfehlermeldungen; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE xfehlermeldungen FROM PUBLIC;
REVOKE ALL ON TABLE xfehlermeldungen FROM postgres;
GRANT ALL ON TABLE xfehlermeldungen TO postgres;
GRANT SELECT,INSERT ON TABLE xfehlermeldungen TO user_georef;
GRANT SELECT ON TABLE xfehlermeldungen TO auhlig;
GRANT SELECT,INSERT ON TABLE xfehlermeldungen TO vkviewer;


--
-- Name: fehlermeldungen_id_seq; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON SEQUENCE fehlermeldungen_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE fehlermeldungen_id_seq FROM postgres;
GRANT ALL ON SEQUENCE fehlermeldungen_id_seq TO postgres;
GRANT SELECT,USAGE ON SEQUENCE fehlermeldungen_id_seq TO user_georef;
GRANT ALL ON SEQUENCE fehlermeldungen_id_seq TO vkviewer;
...
GRANT SELECT ON TABLE geography_columns TO user_wms;
...
GRANT SELECT,INSERT ON TABLE geometry_columns TO user_georef;
GRANT SELECT ON TABLE geometry_columns TO user_wms;
GRANT SELECT ON TABLE geometry_columns TO vkviewer;


--
-- Name: georeferenzierungsprozess; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE georeferenzierungsprozess FROM PUBLIC;
REVOKE ALL ON TABLE georeferenzierungsprozess FROM postgres;
GRANT ALL ON TABLE georeferenzierungsprozess TO postgres;
GRANT SELECT,INSERT,UPDATE ON TABLE georeferenzierungsprozess TO user_georef;
GRANT SELECT,UPDATE ON TABLE georeferenzierungsprozess TO auhlig;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE georeferenzierungsprozess TO vkviewer;
GRANT SELECT ON TABLE georeferenzierungsprozess TO vkrostock;


--
-- Name: georeferenzierungsprozess_id_seq; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON SEQUENCE georeferenzierungsprozess_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE georeferenzierungsprozess_id_seq FROM postgres;
GRANT ALL ON SEQUENCE georeferenzierungsprozess_id_seq TO postgres;
GRANT SELECT,USAGE ON SEQUENCE georeferenzierungsprozess_id_seq TO user_georef;
GRANT ALL ON SEQUENCE georeferenzierungsprozess_id_seq TO vkviewer;


--
-- Name: gt_pk_metadata_table; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE gt_pk_metadata_table FROM PUBLIC;
REVOKE ALL ON TABLE gt_pk_metadata_table FROM postgres;
GRANT ALL ON TABLE gt_pk_metadata_table TO postgres;
GRANT SELECT ON TABLE gt_pk_metadata_table TO user_wms;
...
GRANT SELECT ON TABLE layer TO user_georef;


--
-- Name: map; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE map FROM PUBLIC;
REVOKE ALL ON TABLE map FROM postgres;
GRANT ALL ON TABLE map TO postgres;
GRANT SELECT,INSERT,UPDATE ON TABLE map TO vkviewer;
GRANT SELECT ON TABLE map TO user_georef;
GRANT SELECT ON TABLE map TO user_wms;


--
-- Name: maps_id_seq; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON SEQUENCE maps_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE maps_id_seq FROM postgres;
GRANT ALL ON SEQUENCE maps_id_seq TO postgres;
GRANT ALL ON SEQUENCE maps_id_seq TO vkviewer;
...
GRANT SELECT,INSERT,UPDATE ON TABLE metadata TO vkviewer;
GRANT SELECT ON TABLE metadata TO user_georef;
GRANT SELECT ON TABLE metadata TO user_wms;


--
-- Name: refmaplayer; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE refmaplayer FROM PUBLIC;
REVOKE ALL ON TABLE refmaplayer FROM postgres;
GRANT ALL ON TABLE refmaplayer TO postgres;
GRANT SELECT,INSERT ON TABLE refmaplayer TO user_georef;
GRANT SELECT ON TABLE refmaplayer TO user_wms;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE refmaplayer TO vkviewer;
...
GRANT SELECT,INSERT ON TABLE spatial_ref_sys TO user_georef;
GRANT SELECT ON TABLE spatial_ref_sys TO user_wms;
GRANT SELECT ON TABLE spatial_ref_sys TO vkviewer;
GRANT SELECT ON TABLE spatial_ref_sys TO vkrostock;
...
GRANT ALL ON SEQUENCE users_id_seq TO vkviewer;


--
-- Name: vblattschnittmtb; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE vblattschnittmtb FROM PUBLIC;
REVOKE ALL ON TABLE vblattschnittmtb FROM postgres;
GRANT ALL ON TABLE vblattschnittmtb TO postgres;
GRANT SELECT ON TABLE vblattschnittmtb TO vkviewer;


--
-- Name: virtualdatasets; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE virtualdatasets FROM PUBLIC;
REVOKE ALL ON TABLE virtualdatasets FROM postgres;
GRANT ALL ON TABLE virtualdatasets TO postgres;
GRANT SELECT ON TABLE virtualdatasets TO user_wms;
GRANT SELECT,INSERT,UPDATE ON TABLE virtualdatasets TO user_georef;
GRANT SELECT,INSERT,UPDATE ON TABLE virtualdatasets TO vkviewer;


--
-- Name: virtualdatasets_id_seq; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON SEQUENCE virtualdatasets_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE virtualdatasets_id_seq FROM postgres;
GRANT ALL ON SEQUENCE virtualdatasets_id_seq TO postgres;
GRANT ALL ON SEQUENCE virtualdatasets_id_seq TO user_georef;


--
-- Name: vmapsearch; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE vmapsearch FROM PUBLIC;
REVOKE ALL ON TABLE vmapsearch FROM postgres;
GRANT ALL ON TABLE vmapsearch TO postgres;
GRANT SELECT ON TABLE vmapsearch TO user_wms;


--
-- Name: xblattschnitt_mtb; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE xblattschnitt_mtb FROM PUBLIC;
REVOKE ALL ON TABLE xblattschnitt_mtb FROM postgres;
GRANT ALL ON TABLE xblattschnitt_mtb TO postgres;
GRANT SELECT ON TABLE xblattschnitt_mtb TO user_georef;
GRANT SELECT ON TABLE xblattschnitt_mtb TO vkviewer;
GRANT SELECT ON TABLE xblattschnitt_mtb TO vkrostock;
